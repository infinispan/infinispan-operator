...
[![Build Status](https://api.travis-ci.com/infinispan/infinispan-operator.svg?branch=main)](https://travis-ci.com/infinispan/infinispan-operator)
...
Infinispan resources are defined in [infinispan-types.go](https://github.com/infinispan/infinispan-operator/blob/main/pkg/apis/infinispan/v1/infinispan_types.go).
...
Check the
[official operator documentation](https://infinispan.org/docs/infinispan-operator/main/operator.html)
for more details.
