...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSSiteSpec) DeepCopyInto(out *TLSSiteSpec) {
	*out = *in
	if in.TransportKeyStore != nil {
		in, out := &in.TransportKeyStore, &out.TransportKeyStore
		*out = new(CrossSiteKeyStore)
		**out = **in
	}
	if in.RouterKeyStore != nil {
		in, out := &in.RouterKeyStore, &out.RouterKeyStore
		*out = new(CrossSiteKeyStore)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSSiteSpec.
func (in *TLSSiteSpec) DeepCopy() *TLSSiteSpec {
	if in == nil {
		return nil
	}
	out := new(TLSSiteSpec)
