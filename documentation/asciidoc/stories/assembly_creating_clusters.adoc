...
//Community
ifndef::productized[]
* Either install the {ispn_operator} from link:https://www.operatorhub.io/[OperatorHub.io] or link:#deploying_operator_manually[deploy it manually].
...
include::{topics}/con_crd.adoc[leveloffset=+1]
