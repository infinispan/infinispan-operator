...
include::{topics}/proc_configuring_pod_termination_grace_period.adoc[leveloffset=+1]
include::{topics}/proc_configuring_service_accounts.adoc[leveloffset=+1]
include::{topics}/proc_configuring_security_context.adoc[leveloffset=+1]
include::{topics}/con_security_context.adoc[leveloffset=+2]
...
include::{topics}/proc_adding_environments.adoc[leveloffset=+1]
