...
include::{topics}/con_resource_management_cross_site.adoc[leveloffset=+1]
include::{topics}/proc_allocating_cpu_memory_cross_site.adoc[leveloffset=+2]
include::{topics}/proc_disabling_gossip_router_cross_site.adoc[leveloffset=+2]
