...
:server_image_version: 14.0.12
:operand_version: 14.0.12
...
:crystat_installation: https://cryostat.io/get-started/#installing-cryostat-operator[Installing Cryostat Operator]