...
* Remotely access {datagridservice} clusters from Hot Rod or
REST clients and dynamically create caches using any {brandname} cache mode and
configuration.
+
[NOTE]
====
{brandname} does not provide default caches for {datagridservice} pods.
