...
{ispn_operator} watches for `Infinispan` Custom Resources (CR) that you use to instantiate and configure {brandname} clusters and manage {k8s} resources, such as StatefulSets and Services.
