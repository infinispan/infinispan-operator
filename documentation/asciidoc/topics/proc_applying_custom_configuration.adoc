...
Be careful when applying custom configuration outside of the `cache-container` element or field.
...
[TIP]
====
Use the the {brandname} Helm chart to deploy clusters of fully configurable {brandname} Server instances on {openshiftshort}.
====
