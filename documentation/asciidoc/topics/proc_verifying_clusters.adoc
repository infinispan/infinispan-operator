...
[role="_abstract"]
Check that {brandname} nodes have successfully formed clusters.
...
----
+
The response indicates that {brandname} nodes have received clustered views, as in the following example:
+
[source,options="nowrap",subs=attributes+]
----
