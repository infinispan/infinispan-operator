...
import (
	...
	infinispanv1alpha1 "github.com/infinispan/infinispan-operator/pkg/apis/infinispan/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &infinispanv1alpha1.Cache{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &infinispanv1alpha1.Cache{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileCache) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &infinispanv1alpha1.Cache{}
	...
	// Set Cache instance as the owner and controller
...
func newPodForCR(cr *infinispanv1alpha1.Cache) *corev1.Pod {
