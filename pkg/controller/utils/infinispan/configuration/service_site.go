...
func SiteService(siteServiceName string, infinispan *infinispanv1.Infinispan, scheme *runtime.Scheme) (*corev1.Service, error) {
...
func GetOrCreateSiteService(siteServiceName string, infinispan *infinispanv1.Infinispan, client client.Client, scheme *runtime.Scheme, logger logr.Logger) (*corev1.Service, error) {
	siteService := &corev1.Service{}
