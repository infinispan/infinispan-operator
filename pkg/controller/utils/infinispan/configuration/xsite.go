...
func getRemoteSiteServiceHostPort(service *corev1.Service, remoteKubernetes *util.Kubernetes, logger logr.Logger) (string, int32, error) {
...
func getLocalSiteServiceHostPort(service *corev1.Service, infinispan *ispnv1.Infinispan, remoteKubernetes *util.Kubernetes, logger logr.Logger) (string, int32, error) {
	switch serviceType := service.Spec.Type; serviceType {
	case corev1.ServiceTypeNodePort:
