...
SERVER_TAGS=${SERVER_TAGS:-'13.0.10.Final 14.0.1.Final 14.0.6.Final 14.0.9.Final 14.0.13.Final 14.0.17.Final 14.0.19.Final 14.0.20.Final 14.0.21.Final 14.0.24.Final 14.0 15.0.0.Dev06 15.0'}
...
for tag in ${SERVER_TAGS}; do
  docker pull "quay.io/infinispan/server:${tag}" || true
