...
func (k TestKubernetes) WaitForSchemaConditionReady(schemaName, clusterName, namespace string) *ispnv2.Schema {
	return k.WaitForSchemaCondition(schemaName, clusterName, namespace, ispnv2.Condition{
...
func (k TestKubernetes) WaitForSchemaCondition(schemaName, clusterName, namespace string, condition ispnv2.Condition) *ispnv2.Schema {
